                ...
                <div class="row">
                    <div class="col-lg-8 py-3">
                        <article class="blog-entry">
                            <div class="entry-header">
                                <div class="post-thumbnail">
                                    <img src="<?= base_url(); ?>assets/user/img/blogs/blog_4.jpg" alt="">
                                </div>
                                <div class="post-date">
                                    <h3>20</h3>
                                    <span>Feb</span>
                            ...
                            <div class="post-title"><a href="blog-details.html">Duis feugiat neque sed dolor cursus, sed
                            ...
                            <div class="entry-content">
                                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Minima quo officia tenetur
                                    hic
                                    facere animi doloremque adipisci, fugiat ratione corrupti eius amet exercitationem
                                    dolorem inventore eum et placeat, sunt ducimus.</p>
                            </div>
                        ...
                        <article class="blog-entry">
                            <div class="entry-header">
                                <div class="post-thumbnail">
                                    <img src="<?= base_url(); ?>assets/user/img/blogs/blog_5.jpg" alt="">
                                </div>
                                <div class="post-date">
                                    <h3>20</h3>
                                    <span>Feb</span>
                        ...
                        <article class="blog-entry">
                            <div class="entry-header">
                                <div class="post-thumbnail">
                                    <img src="<?= base_url(); ?>assets/user/img/blogs/blog_6.jpg" alt="">
                                </div>
                                <div class="post-date">
                                    <h3>06</h3>
                                    <span>Jan</span>
                    ...
                    <div class="col-lg-4 py-3">
                        ...
                        <div class="widget-wrap">
                            ...
                            <div class="blog-widget">
                                <div class="blog-img">
                                    <img src="<?= base_url(); ?>assets/user/img/blogs/blog_1.jpg" alt="">
                                </div>
                            ...
                            <div class="blog-widget">
                                <div class="blog-img">
                                    <img src="<?= base_url(); ?>assets/user/img/blogs/blog_2.jpg" alt="">
                                </div>
                                <div class="entry-footer">
                                    <div class="blog-title mb-2"><a href="#">Duis feugiat neque sed dolor cursus, sed
                                            lacinia nisl pretium</a></div>
                            ...
                            <div class="blog-widget">
                                <div class="blog-img">
                                    <img src="<?= base_url(); ?>assets/user/img/blogs/blog_3.jpg" alt="">
                                </div>
                                <div class="entry-footer">
                                    <div class="blog-title mb-2"><a href="#">Duis feugiat neque sed dolor cursus, sed
                                            lacinia nisl pretium</a></div>
